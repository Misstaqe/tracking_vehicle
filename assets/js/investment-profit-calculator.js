(function ($) {
	...
	$(document).ready(function () {
		...
		//--------------------------------------------------------------
		// global variable
		var singleCurrency = $(".currency-select-list").find(
			".single-currency-select"
		);
		...
		singleCurrency.on("click", function (e) {
			e.preventDefault();
			var x = $(this)
				.siblings(".single-currency-select")
				.hasClass("selected-currency");
		...
		function showResults() {
			...
			partResult
				.find(".js_totalPercentage")
				.html(totalPercent.toFixed(2) + "%");
			partResult
				.find(".js_dailyProfit")
				.html(currencySign + dailyProfit.toFixed(2));
			partResult
				.find(".js_netProfit")
				.html(currencySign + netProfit.toFixed(2));
			partResult
				.find(".js_totalReturn")
				.html(currencySign + totalReturn.toFixed(2));
		}
