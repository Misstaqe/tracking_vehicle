...
<div style="width: 100%;">
    ...
    <div class="content" style="clear: both;">
    	...
    	<div class="desc-1-1" style="font-size: 14px; width: 50%; float: left; margin-top: 30px;">
            ...
            <div>
                <div><p style="margin-top: 2px; margin-bottom: 2px;">Empfänger: <strong><?=$transaction[0]->b_detail_1?></strong></p></div>
                <div><p style="margin-top: 2px; margin-bottom: 2px;">IBAN: <strong><?=$transaction[0]->b_detail_2?></strong></p></div>
                <div><p style="margin-top: 2px; margin-bottom: 2px;">BIC/SWIFT: <strong><?=$transaction[0]->b_detail_3?></strong></p></div>
                <div><p style="margin-top: 2px; margin-bottom: 2px;">Referenznummer: <strong><?=$transaction[0]->reference?></strong></p></div>
            </div>
    	</div>

    	<div style="width: 50%; float: left; margin-bottom: 260px;">
    		<img src="<?php echo base_url();?>assets/img/phone.png" style="margin-left: 50px;">
    ...
    <div class="footer" style="border-top: 1px solid black; padding-top: 5px; padding-bottom: 20px; font-size: 10px; margin-top: 20px;">
        <div style="width: 10%; float: left;">
            <img src="<?php echo base_url();?>assets/img/pic_footer.png">
        </div>
...
<div style="width: 100%;">
    ...
    <div class="sign" style="margin-top: 130px; z-index: 1; margin-bottom: 200px;">
        <div style="width: 33%; float: right; margin-top: -80px; margin-bottom: 290px;">
            <img src="<?php echo base_url();?>assets/img/sellersignature.png" style="width: 200px; z-index: 4; margin-bottom: -15px;">
		...
		<div style="width: 33%;">
			...
			<div>
				<img src="<?php echo base_url();?>assets/img/final_sign.png" style="margin-top: -100px; margin-left: -20px; z-index: 3;">
			</div>
			<div style="margin-top: 30px; margin-left: 30px;">
				<img src="<?php echo base_url();?>assets/img/stamp.png" style="width: 200px; right: 125px; margin-top: -200px; z-index: 4; margin-left: 55px;">
			</div>
		</div>
    </div>
