...
<section class="section_termsandcond">
    <div class="container">
        ...
        <!-- Lower Content -->
        <div class="lower-content">
            <h2>§ 2 vehicle provision</h2>
            <p>The customer or client has to ensure on the day of collection for a punctual vehicle delivery. In the case of in-saloon overpasses with a red license plate, the vehicle must be ready to drive and must not show any defects which impair its use on the roads in the sense of the STVZO. If the transfer driver is on site and the delivery of the vehicle is delayed by more than 30 minutes, then EUR 52.95 will be charged for every half hour that has begun. If a vehicle is not to be delivered at the agreed place, as well as because of a defect or significant defects, 100% of the transfer price will be charged. If the vehicle can not be loaded on its own, a wind surcharge of EUR 25, - per vehicle will be charged. If the vehicle is not available or ready to be loaded by the agreed date,</p>
        </div>
        ...
        <div class="two-column">
            <h3>§ 4 payers</h3>
            <p>The transfer company must be informed of the order by the freight payer. If the freight payer and the ordering party are not a person or a company, the customer is liable for the freight costs plus incurred default and dunning costs.</p>
        </div>
        ...
        <!-- Lower Content -->
        <div class="lower-content">
            <h2>§ 6 delivery dates</h2>
            <p>Delivery dates are only mentioned or accepted with the order. For delay in delivery due to breakdown, technical defects, failure of a subcontractor or force majeure, no liability is assumed. In particular, this also applies to late orders and for traffic-related delays.</p>
        </div>
        ...
        <div class="lower-content">
            <h2>Low fees</h2>
            <p>The low cost of our secure auto escrow service is paid by the Buyer, the Seller or shared between them.</p>
        </div>

        <!-- Lower Content -->
        <div class="lower-content">
            <h2>Vehicle Amount &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Escrow Fee</h2>
            <p>EUR 0 - EUR5,000&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 3.25% (EUR 10.00 minimum)</p>
            <p>EUR 5,000.01 - EUR 25,000 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; EUR 162.50 + 0.26% of amount over EUR5,000</p>
            <p>over EUR 25,000 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 0.89%</p>
        </div>
